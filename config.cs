...
namespace _prog1
{
    ...
    class config
    {
        ...
        public static string WindowSize = "800,600";
        public static string Entrance = "app/";

        public static void load(string filename)
        {
            var iniFile = new IniFile(filename); 
            BasePath = iniFile.GetValue("app", "BasePath", BasePath);
            WindowSize = iniFile.GetValue("app", "WindowSize", WindowSize);
            Entrance = iniFile.GetValue("app", "Entrance", Entrance); 

        }

    }

    // from https://www.codeproject.com/Tips/771772/A-Simple-and-Efficient-INI-File-Reader-in-Csharp
    // it's License: https://www.codeproject.com/info/cpol10.aspx
